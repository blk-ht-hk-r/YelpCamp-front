         ...
         <div className="cg-card">
            <div className="card__info-hover">
               ...
               <div className="card__clock-info">
                  ...
                  <span className="card__time">{`${date}${month}`}</span>
               </div>
            </div>
            <div
               className="card__img"
            ...
            ></div>
            <Link to={`/campgrounds/${campground._id}`} className="card_link">
               <div
            ...
            <div className="card__info">
               ...
               <Link to={`/campgrounds/${campground._id}`}>
                  <h3 className="card__title">{campground.title}</h3>
               </Link>
